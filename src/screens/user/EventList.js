				...
				<div className="flex flex-col sm:flex-row w-full">
					<div className="md:object-contain xl:object-none lg:w-auto sm:pr-3 xl:pr-6 h-full">
						<img
							...
							className="object-cover w-[12rem] h-full md:w-[12rem] md:h-[7rem] lg:w-[14rem] lg:h-[8rem]"
							alt=""
						/>
					</div>
						...
						<div className="flex flex-row justify-between w-full sm:pr-3 xl:pr-6">
							<div className="grid grid-cols-1">
								<div className="justify-self-start text-[11px] md:text-[12px] lg:text-[14px] font-normal text-[#959CA9]">
									{events.day}, {events.date}
								</div>
								<div className="border-[0.5px] w-28 mt-0.5 rounded">
									<div className="text-[11px] md:text-[12px] lg:text-[14px] font-semibold text-[#6034BE]">
										{events.categories}
									</div>
								</div>
							</div>
